...
\includegraphics[width=0.8\linewidth]{beta distribution with alpha 2 beta 5.png}
\includegraphics[width=0.8\linewidth]{beta distribution with alpha 5 beta 5.png}
\includegraphics[width=0.8\linewidth]{beta distribution with alpha 5 beta 2.png}
\includegraphics[width=0.8\linewidth]{beta distribution with alpha .5 beta .5.png}


\subsection{Population Distribution and Approximation}
\includegraphics[width=0.8\linewidth]{beta distribution alpha 2 beta 5 with sample data.png}
\includegraphics[width=0.8\linewidth]{beta distribution with alpha 5 beta 5 with sample data.png}
\includegraphics[width=0.8\linewidth]{beta distribution with alpha 5 beta 2 with sample data.png}
\includegraphics[width=0.8\linewidth]{beta distribution with alpha .5 beta .5 with sample data.png}
